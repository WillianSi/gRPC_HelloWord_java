...
public class HelloWorldClient {
    ...
    public String getHelloMessage(String name) {
        HelloWorldClass.HelloResponse response = blockingStub.helloMessage(HelloWorldClass.HelloRequest
                .newBuilder().setName(name).build());
        return response.getMessage();
    }

    public Stream<String> getHelloStream(String name) {
        Iterator<HelloWorldClass.HelloResponse> response = blockingStub.helloStream(HelloWorldClass
                .HelloRequest.newBuilder().setName(name).build());
        Spliterator<HelloWorldClass.HelloResponse> splitIterator = Spliterators
                .spliteratorUnknownSize(response, Spliterator.ORDERED);
